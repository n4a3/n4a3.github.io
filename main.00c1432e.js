...
},{"core-js/library/fn/promise":"9u1Q"}],"htFH":[function(require,module,exports) {
...
},{"core-js/library/fn/object/define-property":"3v7p"}],"xM5U":[function(require,module,exports) {
...
},{"../core-js/object/define-property":"6eIq"}],"Tzth":[function(require,module,exports) {
function n(n,o){if(!(n instanceof o))throw new TypeError("Cannot call a class as a function")}module.exports=n;
},{}],"n5FU":[function(require,module,exports) {
...
},{"../core-js/object/define-property":"6eIq"}],"epB2":[function(require,module,exports) {
"use strict";var t=s(require("@babel/runtime-corejs2/core-js/promise")),e=s(require("@babel/runtime-corejs2/helpers/createClass")),i=s(require("@babel/runtime-corejs2/helpers/classCallCheck")),n=s(require("@babel/runtime-corejs2/helpers/defineProperty"));function s(t){return t&&t.__esModule?t:{default:t}}var a=function t(){var e=this;(0,i.default)(this,t),(0,n.default)(this,"el",document.querySelector(".notification")),(0,n.default)(this,"calls",[]),(0,n.default)(this,"texts",[]),(0,n.default)(this,"counter",0),(0,n.default)(this,"getText",function(t){e.texts.push(t.textContent),t.textContent=""}),(0,n.default)(this,"setText",function(t,i){e.isRunning?e.calls.push({element:t,delay:i}):function(){e.isRunning=!0;var n=e.texts[0];e.texts.shift();var s=function(s){setTimeout(function(){t.textContent+=n[s],s==n.length-1&&(e.isRunning=!1,e.counter++,2===e.counter&&setTimeout(c.modal.show,600),e.calls.length&&(e.setText(e.calls[0].element,e.calls[0].delay),e.calls.shift()))},i*(+s+1))};for(var a in n)s(a)}()}),(0,n.default)(this,"show",function(){e.el.classList.remove("hide")})},o=function(){function t(){var e=this;(0,i.default)(this,t),(0,n.default)(this,"ntBtn",document.querySelector(".notification")),(0,n.default)(this,"body",document.querySelector("body")),(0,n.default)(this,"modal",document.querySelector(".modal")),(0,n.default)(this,"modalBg",document.querySelector(".modal__bg")),(0,n.default)(this,"closeBtn",document.querySelector(".modal__close")),(0,n.default)(this,"show",function(){e.body.classList.remove("out"),e.body.classList.add("modal-active")}),(0,n.default)(this,"hide",function(){e.body.classList.add("out")})}return(0,e.default)(t,[{key:"init",value:function(){this.ntBtn.addEventListener("click",this.show),this.closeBtn.addEventListener("click",this.hide),this.modalBg.addEventListener("click",this.hide)}}]),t}(),u=function t(e,s,a,o){var u=this;(0,i.default)(this,t),(0,n.default)(this,"render",function(){u.posY+=u.speed,u.ctx.drawImage(u.image,u.posX,u.posY,u.w,u.h),u.posY>window.innerHeight?c.canvas.removeInstance():requestAnimationFrame(u.render)}),(0,n.default)(this,"init",function(){requestAnimationFrame(u.render)}),this.ctx=a,this.image=e,this.w=Math.floor(Math.random()*(.1*window.innerWidth-20-30)+30),this.h=this.w*(e.height/e.width),this.posX=Math.floor(Math.random()*(window.innerWidth-this.w)),this.posY=-e.height,this.speed=s*(this.w/174)+2,this.id=o},r=function e(){var s=this;(0,i.default)(this,e),(0,n.default)(this,"canvas",document.querySelector(".home__bg")),(0,n.default)(this,"ctx",this.canvas.getContext("2d")),(0,n.default)(this,"files",["block1","block2","block3"]),(0,n.default)(this,"images",[]),(0,n.default)(this,"instances",[]),(0,n.default)(this,"promises",[]),(0,n.default)(this,"loadImg",function(e){return new t.default(function(t){var i=new Image;i.addEventListener("load",function(){t(i),s.images.push(i)}),i.src="./img/canvas/".concat(e,".png")})}),(0,n.default)(this,"counter",0),(0,n.default)(this,"drawImg",function(){s.counter++,s.images.forEach(function(t){var e=window.innerHeight/(256*Math.random()+128);s.instances.push(new u(t,e,s.ctx,s.counter)),s.instances[s.instances.length-1].init()}),setTimeout(s.drawImg,400)}),(0,n.default)(this,"removeInstance",function(){s.instances.shift()}),(0,n.default)(this,"clear",function(){s.ctx.clearRect(0,0,window.innerWidth,window.innerHeight),requestAnimationFrame(s.clear)}),(0,n.default)(this,"init",function(){s.canvas.setAttribute("width",window.innerWidth),s.canvas.setAttribute("height",window.innerHeight),s.files.forEach(function(t){s.promises.push(s.loadImg(t))}),t.default.all(s.promises).then(function(){requestAnimationFrame(s.clear),s.drawImg()})})},l=function(){function t(){(0,i.default)(this,t),(0,n.default)(this,"notif",new a),(0,n.default)(this,"modal",new o),(0,n.default)(this,"canvas",new r),(0,n.default)(this,"notifyEl",document.querySelector(".notification")),(0,n.default)(this,"notifyTexts",document.querySelectorAll(".notification .notification__item"))}return(0,e.default)(t,[{key:"init",value:function(){var t=this;this.notifyEl.classList.remove("no-js"),this.notifyTexts.forEach(function(e){return t.notif.getText(e)}),this.modal.init(),this.canvas.init(),setTimeout(function(){t.notif.show(),t.notifyTexts.forEach(function(e){return t.notif.setText(e,20*Math.random()+30)})},1e3)}}]),t}(),c=new l;c.init();
},{"@babel/runtime-corejs2/core-js/promise":"7eOf","@babel/runtime-corejs2/helpers/createClass":"xM5U","@babel/runtime-corejs2/helpers/classCallCheck":"Tzth","@babel/runtime-corejs2/helpers/defineProperty":"n5FU"}]},{},["epB2"], null)
//# sourceMappingURL=main.00c1432e.js.map